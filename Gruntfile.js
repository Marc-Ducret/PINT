module.exports = function(grunt) {
    ...
    grunt.registerTask('default', ['ts:dev', 'ts:convnet', 'concat:js_server_header', 'copy:materialize', 'copy:mat', 'copy:img', 'copy:jquery_dev', 'copy:requirejs', 'concat:css_dev', 'htmlmin']);
